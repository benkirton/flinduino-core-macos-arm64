...
const uint8_t   digital_pin_to_port_PGM[] = {
    ...
    _IOPORT_PB, // 27   RB5     RPB5/USBID/RB5  
    _IOPORT_PB, // 28   RB4     SOSCI/RPB4/RB4      Boot Switch 
...
const uint16_t  digital_pin_to_bit_mask_PGM[] = {
    ...
    _BV( 5 ) ,  // 27   RB5     RPB5/USBID/RB5 
    _BV( 4 ) ,  // 28   RB4     SOSCI/RPB4/RB4      Boot Switch  	
...
const uint16_t  digital_pin_to_timer_PGM[] = {
    ...
    NOT_ON_TIMER,                           // 27   RB5     RPB5/USBID/RB5       
    NOT_ON_TIMER,                           // 28   RB4     SOSCI/RPB4/RB4 
...
const uint8_t digital_pin_to_pps_out_PGM[] = {
    ...
    _PPS_OUT(_PPS_RPB5R),   // 27   USBID           RB5     RPB5/USBID/RB5       
    _PPS_OUT(_PPS_RPB4R),   // 28   Boot Switch     RB4     SOSCI/RPB4/RB4 
...
const uint8_t digital_pin_to_pps_in_PGM[] = {
    ...
    _PPS_IN(_PPS_RPB5),     // 27   RB5     RPB5/USBID/RB5 
    _PPS_IN(_PPS_RPB4),     // 28   RB4     SOSCI/RPB4/RB4      
...
const uint8_t digital_pin_to_analog_PGM[] = {
   // Pins 0 through 30
    ...
    NOT_ANALOG_PIN,     // 27   RB5     RPB5/USBID/RB5        
    NOT_ANALOG_PIN,     // 28   RB4     SOSCI/RPB4/RB4
